...
//health wobble
var wobHSpeed = 3, wobHDist = 0.4;

Health.prototype.act = function(step) {
  this.wobble += step * wobSpeed;
  var wobHPos = Math.sin(this.wobble) * wobHDist;
  var wobHPosX = Math.cos(this.wobble) * wobHDist;
  this.pos = this.basePos.plus(new Vector(0, wobHPos));
};
...
var level = this;
  ...
  if (type == "lava" && this.status == null) {
    ...
    //Speed boost!
    playerXSpeed = 12;
    //Timer for 5 seconds, result back to original speed
    setTimeout(function(){
        playerXSpeed = 6;
      }, 5000);
    this.actors = this.actors.filter(function(other) {
    ...
    this.player.pos = new Vector(0,0);
  }
};
